    ...
    public FfxParallelSort(ComputeShader cs)
    {
        ...
        if (m_Valid)
        {
                ...
                !cs.IsSupported(m_KernelSum))
            {
                ...
                Debug.Log("m_KernelReduce: " + cs.IsSupported(m_KernelReduce));
                Debug.Log("m_KernelScanAdd: " + cs.IsSupported(m_KernelScanAdd));
                Debug.Log("m_KernelScan: " + cs.IsSupported(m_KernelScan));
                Debug.Log("m_KernelScatter: " + cs.IsSupported(m_KernelScatter));
