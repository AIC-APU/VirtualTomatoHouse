...
namespace Plusplus.VirtualTomatoHouse.Scripts.View.Annotation
{
    public class AnnotationTaker : MonoBehaviour
    {
        ...
        [SerializeField] private UnityEngine.Camera _colorCamera;
        [SerializeField] private UnityEngine.Camera _tagCamera;
        ...
        [Inject] readonly ISaveTextureModel _saveTextureModel;
        #endregion
        ...
        public async UniTask StoreAnnotationPair(int id)
        {
            ...
            _colorCamera.fieldOfView        = _targetCamera.fieldOfView;
            ...
            _tagCamera.fieldOfView        = _targetCamera.fieldOfView;
        ...
        public void Save()
        {
            _saveTextureModel.SaveTexture(_pairList);
        ...
        private async UniTask<Texture2D> CreateTexture(int width, int height, UnityEngine.Camera camera, TextureFormat format)
        {
